...
export const zh = {
  ...
  'delete.session.desc': '这将永久删除该会话的日志记录，且无法撤销。',
  'delete.session.confirm': '删除会话',
  'menu.fork': '分叉会话',
  'menu.archiveSession': '归档会话',
  'menu.closeSession': '关闭会话',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently deletes the session log. This action cannot be undone.',
  'delete.session.confirm': 'Delete session',
